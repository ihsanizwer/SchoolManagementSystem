...
namespace StaffMain.Datasets__unused_ {
    ...
    public partial class bisdbDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/bisdbDataSet11.xsd";
        ...
        public partial class vacancyDataTable : global::System.Data.TypedTableBase<vacancyRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public vacancyRow AddvacancyRow(string vacancy_no, string position_applied, bool status, string salutation, string first_name, string last_name, System.DateTime date_of_birth, string gender, System.DateTime applied_date, System.DateTime interview_date, int contact_no, string address, string email) {
...
namespace StaffMain.Datasets__unused_.bisdbDataSet1TableAdapters {
    ...
    public partial class vacancyTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[vacancy] ([vacancy_no], [position_applied], [status], [salutation], [first_name], [last_name], [date_of_birth], [gender], [applied_date], [interview_date], [contact_no], [address], [email]) VALUES (@vacancy_no, @position_applied, @status, @salutation, @first_name, @last_name, @date_of_birth, @gender, @applied_date, @interview_date, @contact_no, @address, @email);
SELECT vacancy_no, position_applied, status, salutation, first_name, last_name, date_of_birth, gender, applied_date, interview_date, contact_no, address, email FROM vacancy WHERE (vacancy_no = @vacancy_no)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[vacancy] SET [vacancy_no] = @vacancy_no, [position_applied] = @posi" +
                ...
                "ontact_no] = @contact_no, [address] = @address, [email] = @email WHERE (([vacanc" +
                "y_no] = @Original_vacancy_no) AND ((@IsNull_position_applied = 1 AND [position_a" +
                "pplied] IS NULL) OR ([position_applied] = @Original_position_applied)) AND ((@Is" +
                ...
                "tation)) AND ((@IsNull_first_name = 1 AND [first_name] IS NULL) OR ([first_name]" +
                " = @Original_first_name)) AND ((@IsNull_last_name = 1 AND [last_name] IS NULL) O" +
                "R ([last_name] = @Original_last_name)) AND ((@IsNull_date_of_birth = 1 AND [date" +
                "_of_birth] IS NULL) OR ([date_of_birth] = @Original_date_of_birth)) AND ((@IsNul" +
                "l_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNu" +
                "ll_applied_date = 1 AND [applied_date] IS NULL) OR ([applied_date] = @Original_a" +
                "pplied_date)) AND ((@IsNull_interview_date = 1 AND [interview_date] IS NULL) OR " +
                "([interview_date] = @Original_interview_date)) AND ((@IsNull_contact_no = 1 AND " +
                "[contact_no] IS NULL) OR ([contact_no] = @Original_contact_no)) AND ((@IsNull_ad" +
                "dress = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNu" +
                "ll_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)));\r\nSELECT vaca" +
                "ncy_no, position_applied, status, salutation, first_name, last_name, date_of_bir" +
                "th, gender, applied_date, interview_date, contact_no, address, email FROM vacanc" +
                "y WHERE (vacancy_no = @vacancy_no)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT vacancy_no, position_applied, status, salutation, first_name, last_name, d" +
                "ate_of_birth, gender, applied_date, interview_date, contact_no, address, email F" +
                "ROM dbo.vacancy";
        ...
        public virtual int Fill(bisdbDataSet1.vacancyDataTable dataTable) {
        ...
        public virtual bisdbDataSet1.vacancyDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            bisdbDataSet1.vacancyDataTable dataTable = new bisdbDataSet1.vacancyDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(bisdbDataSet1.vacancyDataTable dataTable) {
        ...
        public virtual int Insert(string vacancy_no, string position_applied, global::System.Nullable<bool> status, string salutation, string first_name, string last_name, global::System.Nullable<global::System.DateTime> date_of_birth, string gender, global::System.Nullable<global::System.DateTime> applied_date, global::System.Nullable<global::System.DateTime> interview_date, global::System.Nullable<int> contact_no, string address, string email) {
            if ((vacancy_no == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_vacancy_no == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_vacancy_no));
            }
            if ((Original_position_applied == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(Original_position_applied));
            }
            if ((Original_status.HasValue == true)) {
            ...
            if ((Original_applied_date.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[29].Value = ((System.DateTime)(Original_applied_date.Value));
            }
            else {
            ...
            if ((Original_interview_date.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[31].Value = ((System.DateTime)(Original_interview_date.Value));
            }
            else {
            ...
            if ((Original_contact_no.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[33].Value = ((int)(Original_contact_no.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_address, 
                    string Original_email) {
            return this.Update(Original_vacancy_no, position_applied, status, salutation, first_name, last_name, date_of_birth, gender, applied_date, interview_date, contact_no, address, email, Original_vacancy_no, Original_position_applied, Original_status, Original_salutation, Original_first_name, Original_last_name, Original_date_of_birth, Original_gender, Original_applied_date, Original_interview_date, Original_contact_no, Original_address, Original_email);
        }
    }
