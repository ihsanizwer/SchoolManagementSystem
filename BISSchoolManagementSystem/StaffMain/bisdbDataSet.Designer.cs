...
namespace StaffMain.bisdbDataSetTableAdapters {
...
SELECT vacancy_no, position_applied, status, salutation, first_name, last_name, date_of_birth, gender, applied_date, interview_date, contact_no, address, email FROM vacancy WHERE (vacancy_no = @vacancy_no)";
        ...
        public virtual int Fill(bisdbDataSet.vacancyDataTable dataTable) {
        ...
        public virtual bisdbDataSet.vacancyDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            bisdbDataSet.vacancyDataTable dataTable = new bisdbDataSet.vacancyDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(bisdbDataSet.vacancyDataTable dataTable) {
